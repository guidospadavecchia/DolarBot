...
namespace DolarBot.Modules.InteractiveCommands.Components.Calculator.Buttons
{
    ...
    /// </summary>
    public class RealCalculatorButtonBuilder : ButtonBuilder
    {
        private const ButtonStyle STYLE = ButtonStyle.Secondary;
        private const string DEFAULT_EMOJI = ":1234:";
        public const string Id = "real_calculator_button";

        /// <summary>
        /// Creates a new <see cref="RealCalculatorButtonBuilder"/>.
        /// </summary>
        /// <param name="tag">A custom tag to identify the component or pass data.</param>
        public RealCalculatorButtonBuilder(string tag, IEmote emoji = null) : base(null, $"{Id}:{tag}", STYLE, null, emoji ?? Emoji.Parse(DEFAULT_EMOJI), false) { }
    }
}
